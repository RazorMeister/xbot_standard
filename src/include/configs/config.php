...
(
	...
	'all_functions' => array('change_channel','warning_ban','multi_function','support_channels','get_vip_channel','admins_meeting','groups_security','twitch_yt','ddos_information','afk_group','ban_list','generate_banner','anty_vpn','visitors','client_on_channel','host_message','server_query_online','name_day'), 
	// All functions 'change_channel','warning_ban','groups_security','multi_function','support_channels','get_vip_channel','admins_meeting','twitch_yt','ddos_information','afk_group','ban_list','generate_banner','anty_vpn','visitors','client_on_channel','host_message','server_query_online','name_day'
	...
	*************************************/
	...
	(
		'enabled' => false,
		'X-Key' => '', // You can change at website `https://iphub.info/pricing`
...
(
	...
	*************************************/
	...
	(
		'enabled' => false,
		'server_name' => 'Test XBot-ts3.pl [ONLINE]/[MAX_CLIENTS]', //[ONLINE] - online users, [MAX_CLIENTS] - max clients, 
		'time_interval' => array('weeks' => 0,'days' => 0,'hours' => 0,'minutes' => 0,'seconds' => 10),
		'data' => '1970-01-01 00:00:00',  //Do not change
	),
