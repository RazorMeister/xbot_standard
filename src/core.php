<?php
	...
	**********************************************************************************/
	...
	if(!isset($instance['i']) || !is_numeric($instance['i']) || $instance['i'] < 1 || $instance['i'] > $all_instances)
		die(END.$name.$language['logs']['core']['error']['bad_instance'].END);
	...
	//Sprawdzanie czy są potrzebne pakiety
	if(!in_array('curl', get_loaded_extensions()))                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                
        	die($name.$language['logs']['core']['error']['php_module']."PHP CURL (apt-get install php5-curl | apt-get install php-curl)\n");
	if(!in_array('gd', get_loaded_extensions()))                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                
        	die($name.$language['logs']['core']['error']['php_module']."PHP GD (apt-get install php5-gd | apt-get install php-gd)\n");
